...
if __name__ == "__main__":
    ...
    # Get some tools
    city_facility_tools = semantic_layer.get_tools_for_relation("City", "has_facility", "Facility")
    ...
    # 1. Prepare tools
    relevant_tools = (
        semantic_layer.get_tools_for_relation("City", "has_facility", "Facility") +
        semantic_layer.get_tools_for_relation("Facility", "hosts_event", "ContainerEvent")
    )
    ...
    print(f"      can be safely passed to LLM via DSPy for inference.")
    print("\n" + "=" * 80)
