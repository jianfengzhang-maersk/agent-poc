...
class Shipment(BaseModel):
    ...
    is_delivered: Optional[bool] = Field(None, description='Whether the shipment has been delivered.')
    is_loaded: Optional[bool] = Field(None, description='Whether shipment containers have been loaded on a vessel.')
    is_pending: Optional[bool] = Field(None, description='Whether the shipment is still pending operational actions.')
    place_of_receipt_city: Optional[str] = Field(None, description='City where shipment is first received.')
    place_of_delivery_city: Optional[str] = Field(None, description='Final delivery city of the shipment.')
    last_eta: Optional[datetime.datetime] = Field(None, description='Latest known estimated time of arrival (derived from customer promised ETA).')
    latest_schedule_update_time: Optional[datetime.datetime] = Field(None, description='When the schedule was last updated.')
    booked_by: Optional[BookedByStruct] = Field(None, description='Basic commercial booking party information.')
    consignee: Optional[ConsigneeStruct] = Field(None, description='Consignee customer details.')
    shipper: Optional[ShipperStruct] = Field(None, description='Shipper customer details.')
    containers: Optional[List[ContainersItemStruct]] = Field(None, description='List of containers associated with this shipment.')
    transport_plan: Optional[TransportPlanStruct] = Field(None, description='Simplified current transport plan details.')
    legs_after_last_discharge: Optional[List[LegsAfterLastDischargeItemStruct]] = Field(None, description='Operational legs after last discharge (GCSS RKEM).')
    legs_before_first_load: Optional[List[LegsBeforeFirstLoadItemStruct]] = Field(None, description='Pre-carriage or pre-load legs.')
